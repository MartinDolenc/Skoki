    ...
    for i in id:
        ...
        if i not in bananiID:
            ...
            if 'Team' in [text(r).replace('*', '').strip() for r in stran.xpath("//div[@class='event-header__kind']")][0]:
                ...
                dobiTekmovalcaIzTekme([r.get("href") for r in stran.xpath("//a[@class='table-row table-row_theme_additional']")])
                ...
                dobiTekmovalcaIzTekme([r.get("href") for r in stran.xpath("//div[@id='events-info-results']")[0]
